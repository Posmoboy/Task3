...
const input = document.getElementById('SearchBarIndex');
...
const checkboxesUpcoming = document.getElementById("checkboxesIndex");
...
function FiltrosCruzados(){
  let arrayChecksFilter = CheckboxsFilter(ArrayIndex)
